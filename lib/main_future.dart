...
class _MyMapPageState extends State<MyMapPage> {
  ...
  int Function(Suggestion, Suggestion)? _comparator;
  ...
  Widget mapMaker(BuildContext context, {List<LatLng>? points}) {
    return Column(
      children: [
        Padding(
      ...
      body: FutureBuilder<List<LatLng>>(
          ...
          builder: (BuildContext futureContext,
            ...
            if (!snapshot.hasData || snapshot.data!.isEmpty) {
              return mapMaker(context);
            }

            return mapMaker(context, points: snapshot.data!);
          }),
    );
  }
}
